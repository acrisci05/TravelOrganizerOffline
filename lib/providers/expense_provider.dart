...
// Gestisce le spese di ciascun viaggio e calcola i totali (previsti, effettivi
// e per categoria) usati nella schermata delle spese e nelle statistiche.
class ExpenseProvider extends ChangeNotifier {
  final ExpenseRepository _repo = ExpenseRepository();
  final _uuid = const Uuid();

  // Cache delle spese indicizzata per id del viaggio.
  ...
  // Rimuove dalla cache in memoria le spese di un viaggio eliminato,
  // mantenendo coerenti i totali e le statistiche.
  void clearForTrip(String tripId) {
    _expensesByTrip.remove(tripId);
    notifyListeners();
  }
}
