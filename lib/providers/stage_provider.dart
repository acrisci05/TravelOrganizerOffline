...
// Gestisce le tappe di ciascun viaggio. Tiene in cache le tappe per viaggio
// ([_stagesByTrip]) ed espone operazioni di riordino e duplicazione.
class StageProvider extends ChangeNotifier {
  final StageRepository _repo = StageRepository();
  final _uuid = const Uuid();

  // Cache delle tappe indicizzata per id del viaggio.
