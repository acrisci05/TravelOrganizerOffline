...
// Gestisce le checklist e i loro elementi per ogni viaggio: aggiunta, spunta,
// modifica, eliminazione e duplicazione di una checklist completa.
class ChecklistProvider extends ChangeNotifier {
  final ChecklistRepository _repo = ChecklistRepository();
  final _uuid = const Uuid();

  // Cache delle checklist indicizzata per id del viaggio.
  ...
  // Rimuove dalla cache in memoria le checklist di un viaggio eliminato,
  // mantenendo coerenti le statistiche.
  void clearForTrip(String tripId) {
    _checklistsByTrip.remove(tripId);
    notifyListeners();
  }
}
